...
\begin{table}[h!]
  ...
  \begin{tabular}{
    ...
    \bottomrule
  \end{tabular}
  \caption{Fit parameters for the baseline of Passivation Tests \#5 Heater 1 and 5. The slope values are scaled by a factor of $10^{6}$.}
...
\begin{table}[h!]
  ...
  \begin{tabular}{
    ...
    \bottomrule
  \end{tabular}
  \caption{Fit parameters for the baseline of Passivation Tests \#6 Heater 2 and 3. The slope values are scaled by a factor of $10^{6}$.}
...
\begin{table}[h!]
  ...
  \begin{tabular}{
    ...
    \bottomrule
  \end{tabular}
  \caption{Fit parameters for the baseline of Passivation Tests \#7 Heater 3 and 4. The slope values are scaled by a factor of $10^{6}$.}
...
\begin{table}[h!]
  ...
  \begin{tabular}{
    ...
    \bottomrule
  \end{tabular}
  \caption{Fit parameters for the baseline of Passivation Tests \#9 Heater 5 and Passivation Test \#12 Heater 1. The slope values are scaled by a factor of $10^{6}$.}
...
\begin{table}[h!]
  ...
  \begin{tabular}{
    ...
    \multicolumn{1}{c}{$b / \si{\micro\meter}$}\\
    \midrule
    1 & -556.775 \pm 1.949 & -528.975 \pm 0.011 &   13.2 \pm 2.2 & -530.336 \pm 0.012 \\
    2 & -517.859 \pm 1.828 & -530.364 \pm 0.010 &   -0.1 \pm 1.5 & -530.446 \pm 0.008 \\
    3 & -407.986 \pm 3.647 & -528.764 \pm 0.020 &    6.3 \pm 1.1 & -527.271 \pm 0.006 \\
    4 & -483.067 \pm 2.884 & -529.353 \pm 0.016 & -197.8 \pm 1.0 & -527.391 \pm 0.005 \\
    5 & -346.825 \pm 2.496 & -530.432 \pm 0.014 & -220.4 \pm 1.0 & -528.546 \pm 0.005 \\
    \bottomrule
  \end{tabular}
  \caption{Fit parameters for the baseline of the reference Heater 1 and 2. The slope values are scaled by a factor of $10^{6}$.}
  \label{tab:fitparams_no9_12}
\end{table}
The uncertainties of the slope and intercept were obtained from the covariance matrix of the linear least-squares fit. They therefore quantify the statistical uncertainty of the fitted baseline parameters for the selected baseline regions. These uncertainties do not include all systematic contributions of the profilometer measurement, such as stylus effects, sample positioning, environmental vibrations, or the choice of baseline regions.
